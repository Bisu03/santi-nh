...
const customerbill = () => {
  ...
  const { customerbill } = router.query;

  const fetchDetailsByAdmissionID = () => {
    setLoding(true);
    axios
      .get(`/api/customerbill/${customerbill}`)
      .then(({ data }) => {
          ...
          <div className={medBillStyle.patientdetail}>
            <table className={`${medBillStyle.pateintDetailsTable}`}>
              <tbody>
                ...
                <tr>
                  <th className={medBillStyle.patientdetailR}>Unique ID</th>
                  <td className={medBillStyle.patientdetailR}>
                    {admissionData?.customerId?.uniqueId}
                  </td>
                </tr>
                <tr>
                  <th className={medBillStyle.patientdetailR}>Full Name</th>
                  <td className={medBillStyle.patientdetailR}>
                    {admissionData?.customerId?.fullname || "NUL"}
                  </td>
                </tr>
                <tr>
                  <th className={medBillStyle.patientdetailR}>Gender</th>
                  <td className={medBillStyle.patientdetailR}>
                    {admissionData?.customerId?.gender || "NUL"}{" "}
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table className={`${medBillStyle.pateintDetailsTable}`}>
              <tbody>
                <tr>
                  ...
                  <td className={medBillStyle.patientdetailR}>
                    {admissionData?.customerId?.contactNo || "NUL"}
                  </td>
                </tr>
                <tr>
                  <th className={medBillStyle.patientdetailR}>Age</th>
                  <td className={medBillStyle.patientdetailR}>
                    {admissionData?.customerId?.age || "NUL"}
                  </td>
                </tr>
                <tr>
                  <th className={medBillStyle.patientdetailR}>Contact No</th>
                  <td className={medBillStyle.patientdetailR}>
                    {admissionData?.customerId?.medicalCase || "NUL"}
                  </td>
                </tr>
              </tbody>
            </table>
